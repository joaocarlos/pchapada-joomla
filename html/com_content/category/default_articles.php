...
<?php if (empty($this->items)) : ?>
	...
	<?php if ($this->params->get('show_no_articles',1)) : ?>
		...
		<!--<p class="info">Estamos trabalhando para disponibilizar cada vez mais conteúdo, de forma rápida e 
			eficiente. Todo o trabalho desenvolvido aqui é produzido por uma equipe multidisciplinar, e 
			em alguns casos exige algumas etapas de revisão de conteúdo e formatação.
			Volte em alguns dias para verificar novas atualizações.</p>-->	
	<?php endif; ?>
...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php if ($this->params->get('show_pagination_limit')) : ?>
		<div class="display-limit">
			<h4>Selecione quantos títulos deseja listar</h4>
			<span class="display-text"><?php echo JText::_('JGLOBAL_DISPLAY_NUM'); ?>&#160;</span>
